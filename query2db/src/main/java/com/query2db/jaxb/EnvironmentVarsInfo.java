 ...
 *         &lt;element name="insertDBName" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class EnvironmentVarsInfo {
     ...
     *     
     */
    public String getInsertDBName() {
        return insertDBName;
    }

    /**
     * insertDBName 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setInsertDBName(String value) {
        this.insertDBName = value;
    }
